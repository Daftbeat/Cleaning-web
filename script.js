...
const translations = {
  en: {
    ...
    navAbout: "About us",
    navContact: "Contact",
    heroEyebrow: "Serving San Diego & surrounding areas",
    heroTitle: "Professional cleaning services in San Diego",
    heroSubtitle:
    ...
    aboutTitle: "More than cleaning. We care for your space like it’s our own.",
    aboutText:
      "At Angel Clean Agency, our mission is to give you more than a clean space — we want you to enjoy the comfort, peace of mind, and confidence of knowing your home or business is being cared for by people you can trust. ",
    aboutTextTwo:
      "We believe exceptional cleaning is found in the details. That’s why every visit is handled with care, consistency, and respect for your property.",
    aboutListOne: "Dependable & professional service",
    aboutListTwo: "Attention to every detail",
    aboutListThree: "Respect for your home and belongings",
    aboutListFour: "Consistent, high-quality results",
    aboutListFive: "Clear and honest communication",
    aboutListsix: "English & Spanish service",
    hoursTitle: "Business hours",
    hoursTextOne: "Monday - Saturday: 8:00 a.m. - 8:00 p.m.",
    hoursTextTwo: "Sunday: By appointment",
    areaTitle: "Service area",
    areaTextOne: "San Diego and surrounding areas",
  ...
  es: {
    ...
    navAbout: "Nosotros",
    navContact: "Contacto",
    heroEyebrow: "Atendiendo San Diego y alrededores",
    heroTitle: "Servicios profesionales de limpieza en San Diego",
    heroSubtitle:
    ...
    aboutTitle: "Más que limpieza. Cuidamos tu espacio como si fuera nuestro.",
    aboutText:
      "En Angel Clean Agency nuestra misión es ofrecerte más que un espacio limpio: queremos que disfrutes de comodidad, tranquilidad y confianza al saber que tu hogar o negocio está siendo cuidado por personas en las que puedes confiar.",
    aboutTextTwo:
      "Creemos que la limpieza excepcional está en los detalles. Por eso cada visita se realiza con cuidado, consistencia y respeto por tu propiedad.",
    aboutListOne: "Servicio profesional y confiable",
    aboutListTwo: "Atención a cada detalle",
    aboutListThree: "Respeto por tu hogar y tus pertenencias",
    aboutListFour: "Resultados consistentes y de alta calidad",
    aboutListFive: "Comunicación clara y honesta",
    aboutListsix: "Servicio en inglés y español",
    hoursTitle: "Horario de atención",
    hoursTextOne: "Lunes - Sábado: 8:00 a.m. - 8:00 p.m.",
    hoursTextTwo: "Domingo: Por cita",
    areaTitle: "Área de servicio",
    areaTextOne: "San Diego y áreas cercanas",
